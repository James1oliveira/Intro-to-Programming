...
document.getElementById("body").style.border = "10px blue solid";
...
document.getElementById("leftarm").style.backgroundColor = "#060745ff";
// Change the text color.
document.getElementById("body").style.color = "#1a0b68ff";
// Give Douglas hair.
document.getElementById("head").style.borderTop = "10px orange solid";
