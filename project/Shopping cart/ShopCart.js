...
//this function creats a table where it displays the coluoms where each heading is red 
...
//display each item in the array 
    ...
    //creating a table and coloums and its adding the total to two decimals 
    myTable += "</table>";
    myTable += "<br/><br/><p>Total: " + totalOrderAmt.toFixed(2) + "</p>";

//getting the id with in the html
    document.getElementById("demo").innerHTML = myTable;


}
//creating a check function which this displays the total 
function checkout() {
